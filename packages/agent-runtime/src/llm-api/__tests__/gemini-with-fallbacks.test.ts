import { openrouterModels } from '@bcp/common/old-constants'
import { TEST_AGENT_RUNTIME_IMPL } from '@bcp/common/testing/impl/agent-runtime'
import {
  ABORT_ERROR_MESSAGE,
  promptAborted,
  promptSuccess,
} from '@bcp/common/util/error'
import { afterEach, beforeEach, describe, expect, it, mock } from '@bcp/common/testing/vitest-compat'
