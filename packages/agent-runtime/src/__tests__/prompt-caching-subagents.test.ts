...
import { beforeEach, describe, expect, it } from '@bcp/common/testing/vitest-compat'
...
import type { TextPart } from '@bcp/common/types/messages/content-part'
...
describe('Prompt Caching for Subagents with inheritParentSystemPrompt', () => {
  ...
  it('should validate that agents with inheritParentSystemPrompt cannot have custom systemPrompt', () => {
    ...
    } = require('@bcp/common/types/dynamic-agent-template')
