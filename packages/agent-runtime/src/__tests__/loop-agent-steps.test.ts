import * as analytics from '@bcp/common/analytics'
import { TEST_USER_ID } from '@bcp/common/old-constants'
import { createTestAgentRuntimeParams } from '@bcp/common/testing/fixtures/agent-runtime'
import {
  clearMockedModules,
} from '@bcp/common/testing/mock-modules'
import { setupDbSpies } from '@bcp/common/testing/mocks/database'
import { getInitialSessionState } from '@bcp/common/types/session-state'
import { AbortError, promptSuccess } from '@bcp/common/util/error'
import { assistantMessage, userMessage } from '@bcp/common/util/messages'
import db from '@bcp/internal/db'
import {
  afterAll,
  afterEach,
  beforeAll,
...
import type { DbSpies } from '@bcp/common/testing/mocks/database'
import type { StepGenerator } from '@bcp/common/types/agent-template'
    ...
    it('should propagate error code and server message from 403 APICallError responseBody', async () => {
      ...
      loopAgentStepsBaseParams.promptAiSdkStream = async function* () {
        throw new APICallError({
          statusCode: 403,
          message: 'Forbidden',
          url: 'https://api.bcp.com/v1/chat/completions',
          requestBodyValues: {},
