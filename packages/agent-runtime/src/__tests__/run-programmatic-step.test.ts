...
import type { PublicAgentState } from '@bcp/common/types/agent-template'
import type {
  AgentRuntimeDeps,
...
import type { ToolResultOutput } from '@bcp/common/types/messages/content-part'
