...
import { createMarkdownFileBlock } from '@bcp/common/util/file'
import { truncateString } from '@bcp/common/util/string'
import { closeXml } from '@bcp/common/util/xml'
...
4. Use the 'write_file' tool to save this Markdown summary to a new file with a generated name starting with the prefix 'bcp-export-' like 'bcp-export-topic-of-conversation.md' in the project root directory.

Write file tool format:

<write_file>
<path>bcp-export-file-name.md${closeXml('path')}
<content>
