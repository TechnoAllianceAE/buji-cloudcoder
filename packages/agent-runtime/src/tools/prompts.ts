import { endsAgentStepParam } from '@bcp/common/tools/constants'
import { toolParams } from '@bcp/common/tools/list'
import { AVAILABLE_SKILLS_PLACEHOLDER } from '@bcp/common/tools/params/tool/skill'
import { getToolCallString } from '@bcp/common/tools/utils'
import { buildArray } from '@bcp/common/util/array'
import { formatAvailableSkillsXml } from '@bcp/common/util/skills'
...
export function ensureZodSchema(
  ...
  return convertJsonSchemaToZod(
    schema as Parameters<typeof convertJsonSchemaToZod>[0],
