...
```bash
# Run an example
pnpm run sdk/e2e/examples/code-reviewer.example.ts
```
...
# Everything
pnpm run test:e2e && pnpm run test:integration && pnpm run test:unit:e2e
```
...
### E2E Test Pattern
```typescript
import { describe, test, expect, beforeAll } from '/common/testing/vitest-compat'
...
### Unit Test Pattern
```typescript
import { describe, test, expect, beforeEach } from '/common/testing/vitest-compat'
