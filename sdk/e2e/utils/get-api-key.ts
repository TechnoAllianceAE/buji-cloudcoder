...
const shouldRunLiveE2e = process.env.RUN_BCP_E2E === 'true'

/**
 * Utility to load BCP API key from environment or user credentials.
...
export function getApiKey(): string {
  if (shouldRunLiveE2e) {
    ...
    if (!apiKey) {
      throw new Error(
        'BCP_API_KEY environment variable is required for live e2e tests. ' +
          'Get your API key at https://www.bcp.com/api-keys',
      )
    }
    return apiKey
  }
  ...
  setupE2eMocks()
  process.env.BCP_API_KEY = E2E_MOCK_API_KEY
