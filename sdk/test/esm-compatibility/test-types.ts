...
import {
  BCPClient as ClientClass,
  getCustomToolDefinition,
} from '@bcp/sdk'
import * as FullSDK from '@bcp/sdk'
;
...
(async () => {
  ...
  const testClient: BCPClient = {} as any
  ...
  const dynamicSDK = await import('@bcp/sdk')
  const ClientFromDynamic: typeof ClientClass = dynamicSDK.BCPClient
  console.log('✅ Dynamic imports work in TypeScript ESM')

  // Test 6: Namespace imports work
  const ClientFromNamespace: typeof ClientClass = FullSDK.BCPClient
