...
import {
  ...
  SKILL_FILE_NAME,
  isValidSkillName,
} from '@bcp/common/constants/skills'
import {
  SkillFrontmatterSchema,
  type SkillDefinition,
  type SkillsMap,
} from '@bcp/common/types/skill'
