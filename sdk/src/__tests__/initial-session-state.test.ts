...
import { describe, expect, test, beforeEach } from '@bcp/common/testing/vitest-compat'
import { z } from 'zod/v4'

import { initialSessionState } from '../run-state'

import type { MockStatResult } from '@bcp/common/testing/mock-types'
  ...
  beforeEach(() => {
    mockFs = {
      ...
      exists: async (path: string) => {
        ...
        if (path.includes('.bcpignore')) return true
