...
describe('credentials', () => {
  ...
  describe('getConfigDir', () => {
    test('returns path with environment suffix for non-prod environments', () => {
      ...
      // Returns bcp-test (new path) or manicode-test (legacy fallback)
      expect(dir).toMatch(/bcp-test|manicode-test/)
    ...
    test('returns path without suffix for prod environment', () => {
      ...
      expect(dir).toMatch(/\/bcp$|\/manicode$/)
    })
  ...
  describe('getCredentialsPath', () => {
    test('returns path within config directory', () => {
      ...
      expect(credPath).toMatch(/bcp-test|manicode-test/)
    })
  })
