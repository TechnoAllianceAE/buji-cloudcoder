...
import { describe, expect, test, beforeEach, afterEach, mock, spyOn } from '@bcp/common/testing/vitest-compat'
...
describe('loadLocalAgents', () => {
  ...
  beforeEach(() => {
    tempDir = mkdtempSync(path.join(os.tmpdir(), 'bcp-sdk-load-agents-'))
