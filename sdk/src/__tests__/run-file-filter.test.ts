...
import * as mainPromptModule from '@bcp/agent-runtime/main-prompt'
import { FILE_READ_STATUS } from '@bcp/common/old-constants'
import * as projectFileTree from '@bcp/common/project-file-tree'
import { getInitialSessionState } from '@bcp/common/types/session-state'
import { getStubProjectFileContext } from '@bcp/common/util/file'
import { afterEach, describe, expect, it, mock, spyOn } from '@bcp/common/testing/vitest-compat'

import { BCPClient } from '../client'
...
describe('BCPClientOptions fileFilter', () => {
  afterEach(() => {
    mock.restore()
  })
