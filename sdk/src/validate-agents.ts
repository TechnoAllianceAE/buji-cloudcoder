...
export interface ValidateAgentsOptions {
  ...
  /**
   * The base URL of the BCP website API.
   * Optional - defaults to NEXT_PUBLIC_BCP_APP_URL or environment-based URL.
   * Example: 'https://bujicoder.com'
   */
  websiteUrl?: string
}
 ...
 * const result = await validateAgents(definitions, {
 *   remote: true,
 *   websiteUrl: 'https://bujicoder.com'
 * })
 * ```
 */
