import { describe, expect, test, beforeEach, afterEach, mock } from '@bcp/common/testing/vitest-compat'
import {
  clearMockedModules,
  mockModule,
...
describe('getModelForRequest free-mode guards', () => {
  ...
  beforeEach(async () => {
    ...
    await mockModule('@bcp/common/constants/chatgpt-oauth', () => ({
      CHATGPT_OAUTH_ENABLED: true,
    }))

    // Mock credentials directly with Vitest mocks — the helper resolves
