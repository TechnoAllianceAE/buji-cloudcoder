...
import { Logger } from '@bcp/common/types/contracts/logger'
...
export function codeSearch({
  ...
  return new Promise((resolve) => {
    ...
    childProcess.once('error', (error) => {
      if (isResolved) return
      settle({
        errorMessage: `Failed to execute ripgrep: ${error.message}. Vendored ripgrep not found; ensure @bcp/sdk is up-to-date or set BCP_RG_PATH.`,
      })
    })
  })
}
