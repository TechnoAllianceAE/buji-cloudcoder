...
export const getCliEnv = (): CliEnv => ({
  ...
  BCP_CLI_EDITOR: process.env.BCP_CLI_EDITOR,
  BCP_EDITOR: process.env.BCP_EDITOR,
  ...
  BCP_IS_BINARY: process.env.BCP_IS_BINARY,
  BCP_CLI_VERSION: process.env.BCP_CLI_VERSION,
  BCP_CLI_TARGET: process.env.BCP_CLI_TARGET,
  BCP_RG_PATH: process.env.BCP_RG_PATH,
  BCP_SCROLL_MULTIPLIER: process.env.BCP_SCROLL_MULTIPLIER,
  BCP_PERF_TEST: process.env.BCP_PERF_TEST,
  BCP_MODE: process.env.BCP_MODE,
})
