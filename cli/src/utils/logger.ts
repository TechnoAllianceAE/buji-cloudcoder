...
import { env, IS_DEV, IS_TEST, IS_CI } from '@bcp/common/env'
import { createAnalyticsDispatcher } from '@bcp/common/util/analytics-dispatcher'
import { getAnalyticsEventId } from '@bcp/common/util/analytics-log'
...
function sendAnalyticsAndLog(
  ...
  // In dev mode, use appendFileSync for real-time logging.
