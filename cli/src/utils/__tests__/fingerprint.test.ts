import { describe, test, expect } from '@bcp/common/testing/vitest-compat'
...
describe('fingerprint utilities', () => {
  describe('getFingerprintType', () => {
    ...
    describe('legacy fingerprints', () => {
      test('should detect bcp-cli- prefix as legacy', () => {
        expect(getFingerprintType('bcp-cli-abc12345')).toBe('legacy')
      })
      ...
      test('should detect bcp-cli- prefix with any suffix', () => {
        expect(getFingerprintType('bcp-cli-')).toBe('legacy')
        expect(getFingerprintType('bcp-cli-randomsuffix')).toBe('legacy')
        expect(getFingerprintType('bcp-cli-12345678')).toBe('legacy')
      })
    ...
    describe('unknown fingerprints', () => {
      ...
      test('should return unknown for partial matches', () => {
        ...
        expect(getFingerprintType('bcp-abc123')).toBe('unknown')
        expect(getFingerprintType('lega-abc123')).toBe('unknown')
      })

      test('should return unknown for SDK fingerprints', () => {
        expect(getFingerprintType('bcp-sdk-abc123')).toBe('unknown')
      })
      ...
      test('should be case-sensitive', () => {
        ...
        expect(getFingerprintType('ENHANCED-abc123')).toBe('unknown')
        expect(getFingerprintType('BCP-cli-abc123')).toBe('unknown')
