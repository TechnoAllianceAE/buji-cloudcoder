...
import { describe, test, expect, beforeEach, mock } from '@bcp/common/testing/vitest-compat'
...
import type { AnalyticsClientWithIdentify } from '@bcp/common/analytics-core'
