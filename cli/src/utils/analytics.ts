...
} from '@bcp/common/analytics-core'
import {
  env as defaultEnv,
...
import type { AnalyticsEvent } from '@bcp/common/constants/analytics-events'


// Re-export types from core for backwards compatibility
export type { AnalyticsClientWithIdentify as AnalyticsClient } from '@bcp/common/analytics-core'
