...
import { CREDITS_REFERRAL_BONUS } from '@bcp/common/old-constants'
...
const BCP_REMOVED_COMMAND_IDS = new Set([
  'connect:claude',
  'connect',
  'ads:enable',
  'ads:disable',
...
const BCP_ONLY_COMMAND_IDS = new Set([
  'plan',
])
...
const ALL_SLASH_COMMANDS: SlashCommand[] = [
  ...
  // },
  {
    id: 'usage',
    label: 'usage',
    description: 'Show credit usage and billing summary',
    aliases: ['credits'],
  },
  {
    id: 'subscribe',
  ...
  // },
  {
    id: 'feedback',
    label: 'feedback',
    description: 'Share general feedback about BujiCoderPlus',
  },
  {
    id: 'bash',
    label: 'bash',
  ...
  },
  {
    id: 'models',
    label: 'models',
    description: 'List available models and mode mappings',
  },
  {
    id: 'refresh',
    label: 'refresh',
    description: 'Refresh model-agent assignments from gateway',
  },
  {
    id: 'settings',
    label: 'settings',
    description: 'Configure server address and settings',
  },
  {
    id: 'login',
    label: 'login',
...
export const SLASH_COMMANDS = ALL_SLASH_COMMANDS.filter(
  (cmd) => !BCP_REMOVED_COMMAND_IDS.has(cmd.id),
)
