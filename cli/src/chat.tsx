...
import type { FeedbackCategory } from '@bcp/common/constants/feedback'
...
export const Chat = ({
  ...
  const { ad } = useGravityAd({ enabled: IS_BCP || !hasSubscription })
  ...
  useEffect(() => {
    ...
    globalThis.addEventListener('bcp:send-followup', handleFollowupClick)
    return () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {ad && (IS_BCP || (!adsManuallyDisabled && getAdsEnabled())) && (
          <AdBanner
            ad={ad}
