...
import * as BCPApiModule from '../../utils/bcp-api'
...
describe('fetchUserDetails', () => {
  ...
  beforeEach(() => {
    process.env.NEXT_PUBLIC_BCP_APP_URL = 'https://test.bcp.com'
  })
  ...
  describe('environment validation', () => {
    test('uses shared API client when apiClient is not provided', async () => {
      ...
      spyOn(BCPApiModule, 'getApiClient').mockReturnValue(apiClient as ReturnType<typeof BCPApiModule.getApiClient>)
