import { describe, expect, test, mock, beforeEach, afterEach } from '@bcp/common/testing/vitest-compat'
...
const ensureEnv = () => {
  ...
  process.env.NEXT_PUBLIC_BCP_APP_URL =
    process.env.NEXT_PUBLIC_BCP_APP_URL || 'https://app.bcp.test'
  process.env.NEXT_PUBLIC_SUPPORT_EMAIL =
    process.env.NEXT_PUBLIC_SUPPORT_EMAIL || 'support@bcp.test'
  process.env.NEXT_PUBLIC_POSTHOG_API_KEY =
    process.env.NEXT_PUBLIC_POSTHOG_API_KEY || 'phc_test_key'
  process.env.NEXT_PUBLIC_POSTHOG_HOST_URL =
    process.env.NEXT_PUBLIC_POSTHOG_HOST_URL || 'https://posthog.bcp.test'
  process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY =
    process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY || 'pk_test_123'
  process.env.NEXT_PUBLIC_STRIPE_CUSTOMER_PORTAL =
    process.env.NEXT_PUBLIC_STRIPE_CUSTOMER_PORTAL ||
    'https://stripe.bcp.test'
...
import { createPaymentRequiredError } from '@bcp/sdk'
