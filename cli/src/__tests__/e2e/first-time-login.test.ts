import { describe, test, expect, mock } from '@bcp/common/testing/vitest-compat'

import { createMockLogger } from '@bcp/common/testing/mock-types'
import {
  generateLoginUrl,
  pollLoginStatus,
...
import type { ApiResponse } from '../../utils/bcp-api'
