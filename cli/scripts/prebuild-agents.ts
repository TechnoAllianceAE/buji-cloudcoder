 ...
 *   pnpm exec tsx scripts/prebuild-agents.ts
 */
...
const AGENTS_DIR = path.join(SCRIPT_DIR, '../../agents')
const OUTPUT_FILE = path.join(SCRIPT_DIR, '../src/agents/bundled-agents.generated.ts')
 ...
 * These are the default BCP agents that ship with the CLI binary.
 */
