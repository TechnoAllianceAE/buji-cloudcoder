 ...
 * } from '@bcp/common/testing/mock-types'
 *
...
import { mock } from '@bcp/common/testing/vitest-compat'
...
/**
 * Typed mock logger where each method is a Vitest mock.
...
/**
 * Creates a mock logger with all methods as Vitest mocks.
