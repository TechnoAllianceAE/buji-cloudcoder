/**
 * Consolidated testing utilities for BujiCoderPlus.
 *
...
//   - '@bcp/common/testing-env-process' for process env
//   - '@bcp/common/testing-env-ci' for CI env
