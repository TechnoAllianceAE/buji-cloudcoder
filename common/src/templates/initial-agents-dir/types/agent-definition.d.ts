/**
 * BujiCoderPlus Agent Type Definitions
 *
 * This file provides TypeScript type definitions for creating custom BujiCoderPlus agents.
...
export interface AgentDefinition {
    ...
    /** Other agents this agent can spawn, like 'bcp/file-picker@0.0.1'.
     *
     * Use the fully qualified agent id from the agent store, including publisher and version: 'bcp/file-picker@0.0.1'
 ...
 */
export type ModelName = 'openai/gpt-5.3' | 'openai/gpt-5.3-codex' | 'openai/gpt-5.2' | 'openai/gpt-5.1' | 'openai/gpt-5.1-chat' | 'openai/gpt-5-mini' | 'openai/gpt-5-nano' | 'anthropic/claude-sonnet-4.6' | 'anthropic/claude-opus-4.6' | 'anthropic/claude-haiku-4.5' | 'anthropic/claude-sonnet-4.5' | 'anthropic/claude-opus-4.1' | 'google/gemini-3-pro-preview' | 'google/gemini-3-flash-preview' | 'google/gemini-3.1-flash-lite-preview' | 'google/gemini-2.5-pro' | 'google/gemini-2.5-flash' | 'google/gemini-2.5-flash-lite' | 'x-ai/grok-4-fast' | 'x-ai/grok-4.1-fast' | 'x-ai/grok-code-fast-1' | 'qwen/qwen3-max' | 'qwen/qwen3-coder-plus' | 'qwen/qwen3-coder' | 'qwen/qwen3-coder:nitro' | 'qwen/qwen3-coder-flash' | 'qwen/qwen3-235b-a22b-2507' | 'qwen/qwen3-235b-a22b-2507:nitro' | 'qwen/qwen3-235b-a22b-thinking-2507' | 'qwen/qwen3-235b-a22b-thinking-2507:nitro' | 'qwen/qwen3-30b-a3b' | 'qwen/qwen3-30b-a3b:nitro' | 'deepseek/deepseek-chat-v3-0324' | 'deepseek/deepseek-chat-v3-0324:nitro' | 'deepseek/deepseek-r1-0528' | 'deepseek/deepseek-r1-0528:nitro' | 'moonshotai/kimi-k2' | 'moonshotai/kimi-k2:nitro' | 'moonshotai/kimi-k2.5' | 'moonshotai/kimi-k2.5:nitro' | 'z-ai/glm-5' | 'z-ai/glm-4.6' | 'z-ai/glm-4.6:nitro' | 'z-ai/glm-4.7' | 'z-ai/glm-4.7:nitro' | 'z-ai/glm-4.7-flash' | 'z-ai/glm-4.7-flash:nitro' | 'minimax/minimax-m2.5' | (string & {});
