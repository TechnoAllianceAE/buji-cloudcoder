...
import type {
  ...
  ToolMessage,
  UserMessage,
} from '../types/messages/bcp-message'
...
>(obj: T): T {
  ...
  /* 'codebuff'/'bcp' provider name is not compatible with providerMetadata for
...
function assistantToBCPMessage(
