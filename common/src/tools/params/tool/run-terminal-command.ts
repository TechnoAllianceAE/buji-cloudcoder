...
6. Use the wrong package manager for the project. For example, if the project uses \`pnpm\` or \`yarn\`, you should not use \`npm\`. Similarly not everyone uses \`pip\` for python, etc.
