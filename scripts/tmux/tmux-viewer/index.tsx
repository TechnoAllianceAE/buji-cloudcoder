...
async function main(): Promise<void> {
  ...
  if (!session) {
    ...
    if (sessions.length === 0) {
      ...
      console.log('')
      console.log('Usage:')
      console.log('  tsx scripts/tmux/tmux-viewer/index.tsx <session-name>')
      console.log('  tsx scripts/tmux/tmux-viewer/index.tsx <session-name> --json')
      console.log('  tsx scripts/tmux/tmux-viewer/index.tsx <session-name> --export-gif output.gif')
      console.log('  tsx scripts/tmux/tmux-viewer/index.tsx --list')
      console.log('')
      console.log(dim('Start a session with: ./scripts/tmux/tmux-cli.sh start'))
      process.exit(1)
    }
