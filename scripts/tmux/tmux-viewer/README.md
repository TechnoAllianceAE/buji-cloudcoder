...
tsx scripts/tmux/tmux-viewer/index.tsx <session-name>

# Start in replay mode (auto-plays through captures like a video)
tsx scripts/tmux/tmux-viewer/index.tsx <session-name> --replay

# JSON output (for AIs)
tsx scripts/tmux/tmux-viewer/index.tsx <session-name> --json

# Export as animated GIF
tsx scripts/tmux/tmux-viewer/index.tsx <session-name> --export-gif output.gif

# Export with custom frame delay (default: 1500ms)
tsx scripts/tmux/tmux-viewer/index.tsx <session-name> --export-gif output.gif --frame-delay 2000

# Export with custom font size (default: 14px)
tsx scripts/tmux/tmux-viewer/index.tsx <session-name> --export-gif output.gif --font-size 16

# List available sessions
tsx scripts/tmux/tmux-viewer/index.tsx --list

# View most recent session (if no session specified)
tsx scripts/tmux/tmux-viewer/index.tsx
```

Or using the npm script:

```bash
cd scripts/tmux && pnpm run view-session <session-name>
```
...
tsx scripts/tmux/tmux-viewer/index.tsx my-session --replay
...
// tsx scripts/tmux/tmux-viewer/index.tsx cli-test-123 --json
```
...
tsx scripts/tmux/tmux-viewer/index.tsx my-session --export-gif

# Specify output path
tsx scripts/tmux/tmux-viewer/index.tsx my-session --export-gif demo.gif

# Fast playback (500ms per frame)
tsx scripts/tmux/tmux-viewer/index.tsx my-session --export-gif fast.gif --frame-delay 500

# Larger text for readability
tsx scripts/tmux/tmux-viewer/index.tsx my-session --export-gif large.gif --font-size 18
```
...
```bash
# Typecheck
cd scripts/tmux/tmux-viewer && tsc --noEmit
