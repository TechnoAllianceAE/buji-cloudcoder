 ...
 *
 * Usage:
 *   tsx scripts/test-fireworks-long.ts
 */
...
- We use a mono-repo structure managed with Turborepo and pnpm workspaces with remote caching
